...
from routes.dashborad_routes import app as dashboard_app
...
# # Custom 405 error handler (Method Not Allowed):
@app.errorhandler(405)
def method_not_allowed_error(e):
    checked_user = check_user_id()
    if checked_user:
        return render_template('general/not_found_error404.html', checked_user=checked_user), 405
    return render_template('general/not_found_error404.html'), 405
...
def handle_error(e):
    checked_user = check_user_id()
    if checked_user:
        return render_template('general/not_found_error404.html', checked_user=checked_user), e.code
    return render_template('general/not_found_error404.html'), e.code
